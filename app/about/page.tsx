...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-[#f5f5f5] text-black pt-32 xl:pt-72 pb-20 xl:pb-60 px-5 xl:px-52">
      <div className="flex flex-col md:flex-row xl:justify-center xl:items-start xl:gap-28 bg-red-500 xl:mx-20 xl:h-[600px]">
        <Image
